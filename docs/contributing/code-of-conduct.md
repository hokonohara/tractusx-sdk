...
The code of conduct followed by the Eclipse-Tractus-X-SDK community is available in the [Code-ofConduct File](https://github.com/eclipse-tractusx/tractusx-sdk/blob/main/CODE_OF_CONDUCT.md) and replicated below.
